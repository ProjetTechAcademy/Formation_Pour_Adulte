...
const ecfData = [
  {
    ...
    questions: [
      ...
      {
        q: "2. A partir du synopsis en annexe 1, rédigez le scénario pédagogique en utilisant le tableau de l’annexe 2.",
        links: [
          {
      ...
      {
        q: "3. A partir de l’annexe 3, rédigez le contenu de la grille d’évaluation de mise en pratique sur le terrain de la formation « Prévenir les risques liés à la manutention dans l’aménagement paysager ».",
        links: [
          {
  ...
  },
  {
    ...
    icon: "🎤",
    color: "bg-paia-yellow",
    border: "border-paia-yellow",
    text: "text-paia-yellow",
    questions: [
      {
        q: '1. Lors de la formation "Prévenir les risques liés à la manutention dans l’aménagement paysager", vous projetez un diaporama sur "les principes ergonomiques". Vous remarquez que les deux personnes allophones décrochent et ne vous écoutent plus. Proposez 5 actions minimum à mettre en place pour ces deux salariés.',
        links: [
          {
            code: "098_FPA_B2_M08_S002",
            label:
              "098_FPA_B2_M08_S002 - Remédier aux difficultés d'apprentissage",
            bloc: "B2",
          },
          {
            code: "100_FPA_B2_M09_S001",
            label:
      ...
      {
        q: '2. Pour anticiper et pallier la difficulté dessalariés allophones à suivre un diaporama sur "les principes ergonomiques" lors de cette formation, il est essentiel d\'adapter les supports et méthodes dès la préparation. Décrivez 5 propositions concrètes d’amélioration de votre support de présentation.',
        links: [
          {
            code: "050_FPA_B1_M12_S003",
            label: "050_FPA_B1_M12_S003 - La méthode FALC",
            bloc: "B1",
          },
          {
            code: "078_FPA_B2_M04_S002",
            label:
      ...
      {
        q: '3. Vous avez animé le module de formation "Prévenir les risques liés à la manutention dans l’aménagement paysager". Les deux évaluations proposées pour la partie théorie et pratique ne vous satisfont pas. Décrivez 5 propositions d’évaluation en prenant en considération les deux salariés allophones.',
        links: [
          {
            code: "087_FPA_B2_M05_S004",
            label:
      ...
      {
        q: "4. Avec votre même groupe de salariés en insertion, vous devez travailler autour de la rédaction du CV. Un des salariés ne sait pas utiliser les outils informatiques. Explicitez 5 techniques vous permettant de l'accompagner et de l’impliquer dans la rédaction de son CV.",
        links: [
          {
            code: "101_FPA_B2_M09_S002",
            label:
  ...
  },
  {
    ...
    icon: "🤝",
    color: "bg-paia-bronze",
    border: "border-paia-bronze",
    text: "text-paia-bronze",
    questions: [
      {
        ...
        links: [
          {
            code: "106_FPA_B3_M02_S001",
            label: "106_FPA_B3_M02_S001 - Les techniques d'entretien",
            bloc: "B3",
          },
        ],
      },
      {
        q: '2. Vous avez débuté le module "rédiger efficacement son CV et sa lettre de motivation", lors de la deuxième séance vous accueillez un nouvel apprenant. Indiquez les étapes à mettre en place pour son accueil et la co-construction de son parcours de formation ?',
        links: [
          {
            code: "121_FPA_B3_M06_S001",
            label:
              "121_FPA_B3_M06_S001 - L'accueil individuel d'un apprenant en formation",
            bloc: "B3",
          },
          {
            code: "119_FPA_B3_M05_S003",
            label:
  ...
  },
  {
    ...
    icon: "🔎",
    color: "bg-paia-dark",
    border: "border-paia-dark",
    text: "text-paia-dark",
    questions: [
      {
        q: "1. L’organisme TForm’ souhaite obtenir la certification Qualiopi, dressez une liste des critères de conformité pour la formation continue pour adultes et les documents de preuves à fournir.",
        links: [
          {
            code: "149_FPA_B4_M01_S003",
            label: "149_FPA_B4_M01_S003 - Les réglementations Qualiopi",
            bloc: "B4",
          },
        ],
      },
      {
        q: "2. Élaborez une stratégie de veille professionnelle qui vous permettra de rester à la pointe dans le domaine de l’accompagnement à l’emploi (rédaction de CV, aide au recrutement, …) et d'intégrer les dernières innovations pédagogiques et technologiques dans vos formations.",
        links: [
          {
            code: "162_FPA_B4_M03_S001",
            label: "162_FPA_B4_M03_S001 - La veille professionnelle",
            bloc: "B4",
          },
        ],
      },
      {
        q: '3. Pour réaliser votre veille de manière efficace,sur "Accompagner à l’emploi, les premières démarches de manière efficace" "Rédiger un CV", vous utilisez différentes sources. Citez au minimum cinq types de sources.',
        links: [
          {
            code: "164_FPA_B4_M03_S003",
            label:
              "164_FPA_B4_M03_S003 - Méthodologies de recherche, de capitalisation d'informations et d'organisation de la veille",
            bloc: "B4",
          },
          {
            code: "165_FPA_B4_M03_S004",
            label:
      ...
      {
        q: "4. En tant que formateur junior recruté chez TForm', vous effectuez régulièrement des analyses de votre pratique professionnelle. Proposez un processus d'auto-évaluation et de développement professionnel continu pour affiner et améliorer vos pratiques de formateur.",
        links: [
          {
            code: "172_FPA_B4_M05_S004",
            label: "172_FPA_B4_M05_S004 - Analyser ses pratiques de formation",
            bloc: "B4",
          },
        ],
      },
...
const dataProgram = {
    ...
    modules: [
      ...
      },
      {
        ...
        sujets: [
          ...
          "000_FPA_B0_M02_S004 - Ananimé une classe virtuelle",
          "000_FPA_B0_M02_S005 - Les outils de la classe virtuelle",
        ],
      },
      {
        title: "M03 : Pédagogie Inversée",
        sujets: [
  ...
  bloc3: {
    id: "bloc3",
    themeKey: "bloc3",
    title: "B3 : Accompagner",
    icon: "🤝",
    modules: [
      {
        title: "M01 : Diagnostiquer",
        sujets: [
      ...
      {
        title: "M10 : AFEST",
        sujets: ["137_FPA_B3_M10_S001 - Le tutorat en entreprise"],
      },
      {
        title: "M11 : Insertion",
        sujets: [
...
const dataEvaluations = {
  eval_ccp1: {
    ...
    themeKey: "bloc1",
    title: "B1 : Concevoir",
    subtitle: "Évaluations du Bloc 1",
    icon: "🏗️",
    items: [
      { id: "e_c1_ecf_ent", title: "ECF d'entraînement - CCP1" },
      { id: "e_c1_dt_d1", title: "Dossier technique Chap. 1 - Dépôt 1" },
      { id: "e_c1_dt_d2", title: "Dossier technique Chap. 1 - Dépôt 2" },
      { id: "e_c1_dt_df", title: "Dossier technique Chap. 1 - Dépôt final" },
      { id: "e_c1_ecf_fin", title: "ECF Finale 2026 - CCP1" },
    ],
  },
  eval_ccp2: {
    id: "eval_ccp2",
    themeKey: "bloc2",
    title: "B2 : Animer",
    subtitle: "Évaluations du Bloc 2",
    icon: "🎤",
    items: [
      { id: "e_c2_ecf_ent", title: "ECF d'entraînement - CCP2" },
      { id: "e_c2_dt_d1", title: "Dossier technique Chap. 2 - Dépôt 1" },
      { id: "e_c2_dt_d2", title: "Dossier technique Chap. 2 - Dépôt 2" },
      { id: "e_c2_dt_df", title: "Dossier technique Chap. 2 - Dépôt final" },
      { id: "e_c2_ecf_fin", title: "ECF Finale 2026 - CCP2" },
    ],
  },
  eval_ccp3: {
    id: "eval_ccp3",
    themeKey: "bloc3",
    title: "B3 : Accompagner",
    subtitle: "Évaluations du Bloc 3",
    icon: "🤝",
    items: [
      { id: "e_c3_ecf_ent", title: "ECF d'entraînement - CCP3" },
      { id: "e_c3_dt_d1", title: "Dossier technique Chap. 3 - Dépôt 1" },
      { id: "e_c3_dt_d2", title: "Dossier technique Chap. 3 - Dépôt 2" },
      { id: "e_c3_dt_df", title: "Dossier technique Chap. 3 - Dépôt final" },
      { id: "e_c3_ecf_fin", title: "ECF Finale 2026 - CCP3" },
    ],
  },
  eval_ccp4: {
    id: "eval_ccp4",
    themeKey: "bloc4",
    title: "B4 : Qualité",
    subtitle: "Évaluations du Bloc 4",
    icon: "🔎",
    items: [
      { id: "e_c4_ecf_ent", title: "ECF d'entraînement - CCP4" },
      { id: "e_c4_dt_d1", title: "Dossier technique Chap. 4 - Dépôt 1" },
      { id: "e_c4_dt_d2", title: "Dossier technique Chap. 4 - Dépôt 2" },
      { id: "e_c4_dt_df", title: "Dossier technique Chap. 4 - Dépôt final" },
      { id: "e_c4_ecf_fin", title: "ECF Finale 2026 - CCP4" },
    ],
  },
  eval_trans: {
    id: "eval_trans",
    themeKey: "trans",
    title: "Évaluations Transverses",
    subtitle: "Dossier Pro & Examens Finaux",
    icon: "🏆",
    items: [
      {
        id: "e_tr_dp_grille",
        title: "Dossier Professionnel - Grille de validation",
      },
      { id: "e_tr_dp_d1", title: "Dossier Professionnel - 1er dépôt" },
      { id: "e_tr_dp_d2", title: "Dossier Professionnel - 2ème dépôt" },
      { id: "e_tr_dp_df", title: "Dossier Professionnel - Dépôt final" },
      { id: "e_tr_stage", title: "Grille de stage : évaluation du tuteur" },
      { id: "e_tr_test", title: "Tester mes connaissances" },
      { id: "e_tr_oral_q", title: "Entrainement au questionnement (Oral)" },
      {
        id: "e_tr_oral_t",
        title: "Entraînement à l'oral de l'entretien technique",
      },
      {
        id: "e_tr_ecf_glob",
        title: "Evaluation ECF Finale - Dépôt global (19/11/26)",
      },
    ],
  },
};
...
function initProgressCounts() {
  Object.values(dataProgram).forEach((bloc) => {
    ...
    bloc.modules.forEach((mod) => {
      if (mod.sujets) count += mod.sujets.length;
    });
...
function loadState() {
  ...
  if (data.evalInProgress)
    progressState.evaluations.inProgress = new Set(data.evalInProgress);
  if (data.evalCompleted)
    progressState.evaluations.completed = new Set(data.evalCompleted);
  ...
  if (data.evalReturnDates)
    progressState.evaluations.returnDates = data.evalReturnDates;
}
...
function switchCertifTab(tabId) {
  document.querySelectorAll(".certif-tab-btn").forEach((btn) => {
  ...
  document
    .querySelectorAll(".certif-tab-content")
...
window.calculateReturnDate = function () {
  ...
  if (resInput)
    resInput.value = date.toLocaleDateString("fr-FR", {
      weekday: "long",
      year: "numeric",
      month: "long",
      day: "numeric",
...
window.handleEvalDateChange = function (evalId, val, type) {
  if (type === "depot") {
    ...
    if (val) {
      ...
      document
        .querySelectorAll(`.eval-date-retour-${evalId}`)
        .forEach((inp) => {
          inp.value = retVal;
        });
    }
...
function generateEvalRowHtml(item, isAccordion) {
  ...
  const isChecked =
    progressState.evaluations.inProgress.has(item.id) ||
    progressState.evaluations.completed.has(item.id)
      ? "checked"
      : "";
  ...
  if (status === "envoye" && retVal) {
    ...
    const formattedRetDate = dateObj.toLocaleDateString("fr-FR", {
      day: "numeric",
      month: "short",
    });
...
window.toggleEvalInProgress = function (evalId) {
  ...
  if (chk && chk.checked) set.add(evalId);
  else set.delete(evalId);
  saveState();
  applyEvalStyles(evalId);
};
  ...
  lis.forEach((row) => {
    ...
    if (isCompleted) {
      ...
      if (status === "valide" || status === "termine") {
        ...
        badgeHtml =
          '<span class="text-[10px] px-3 py-1 bg-blue-500 text-white font-black rounded-full uppercase shadow-[2px_2px_0px_#0F2C48] border border-paia-blue">Validé ✅</span>';
      } else if (status === "livret_recu") {
        row.classList.add("bg-blue-50");
        badgeHtml =
          '<span class="text-[10px] px-3 py-1 bg-blue-600 text-white font-black rounded-full uppercase shadow-[2px_2px_0px_#0F2C48] border border-paia-blue">Livret Reçu 📖✅</span>';
      } else if (status === "envoye") {
        row.classList.add("bg-teal-50");
        badgeHtml =
          '<span class="text-[10px] px-3 py-1 bg-teal-500 text-white font-black rounded-full uppercase shadow-[2px_2px_0px_#0F2C48] border border-paia-blue">Envoyé 🚀</span>';
        ...
        badgeHtml =
          '<span class="text-[10px] px-3 py-1 bg-pink-500 text-white font-black rounded-full uppercase shadow-[2px_2px_0px_#0F2C48] border border-paia-blue">À Refaire ❌</span>';
        if (isEcf && extraActions) {
        ...
        badgeHtml =
          '<span class="text-[10px] px-3 py-1 bg-gray-400 text-white font-bold rounded-full uppercase shadow-sm">Ignoré</span>';
      }

      if (extraActions)
        extraActions.innerHTML += `<button onclick="resetEvalStatus('${evalId}')" class="text-[10px] text-gray-400 hover:text-red-500 ml-1 transition-colors" title="Réinitialiser" aria-label="Réinitialiser l'évaluation"><i class="fas fa-undo"></i></button>`;
      ...
      const btnBase =
        "text-[10px] px-3 py-1.5 font-black rounded-lg border-2 border-paia-blue shadow-[2px_2px_0px_#0F2C48] transition-all hover:translate-y-[-1px] active:translate-y-[1px] active:shadow-[0px_0px_0px_#0F2C48] ";
      if (isEcf) {
...
function updateProgressUI() {
  ...
  let evalTotal = progressState.evaluations.total;
  let evalCompleted = 0;
  Object.values(dataEvaluations).forEach((col) => {
    let colTotal = col.items.length;
    let colCompleted = 0;
    col.items.forEach((item) => {
      const st = progressState.evaluations.statuses[item.id];
      if (["valide", "livret_recu", "termine", "ignore"].includes(st))
        colCompleted++;
    });
    const colBar = document.getElementById(`prog-eval-${col.id}`);
    if (colBar)
      colBar.style.width = `${colTotal === 0 ? 0 : Math.round((colCompleted / colTotal) * 100)}%`;
  ...
  globalTotal += evalTotal;
  globalCompleted += evalCompleted;
  const globalPercentage =
    globalTotal === 0 ? 0 : Math.round((globalCompleted / globalTotal) * 100);

  const gPerc = document.getElementById("global-percentage");
  if (gPerc) gPerc.innerText = globalPercentage;
  const gCompCount = document.getElementById("global-completed-count");
  if (gCompCount) gCompCount.innerText = globalCompleted;
  const gTotalCount = document.getElementById("global-total-count");
  if (gTotalCount) gTotalCount.innerText = globalTotal;
}
...
window.switchEvalTab = function (evalId) {
  Object.values(dataEvaluations).forEach((col) => {
    ...
    if (btn)
      btn.className = `flex-shrink-0 px-5 py-2.5 rounded-full text-sm font-bold transition-all shadow-sm border-2 bg-white ${themes[col.themeKey].text} hover:bg-paia-ivory border-paia-blue flex items-center gap-2 shadow-[3px_3px_0px_#0F2C48]`;
  ...
  if (activeBtn)
    activeBtn.className = `flex-shrink-0 px-5 py-2.5 rounded-full text-sm font-bold transition-all shadow-[1px_1px_0px_#0F2C48] transform translate-y-1 border-2 border-paia-blue ${themes[activeCol.themeKey].bg} text-white flex items-center gap-2`;
...
function selectBloc(blocId) {
  ...
  Object.values(dataProgram).forEach((b) => {
    ...
    if (btn) {
      btn.classList.remove(
        ...
        "border-paia-bronze",
        "border-paia-dark",
        "shadow-[4px_4px_0px_#0F2C48]",
      );
      if (b.id === blocId)
        btn.classList.add("border-paia-blue", "shadow-[4px_4px_0px_#0F2C48]");
    }
  });
  const titleEl = document.getElementById("current-bloc-title");
  if (titleEl)
    titleEl.innerHTML = `<span class="mr-2">${bloc.icon}</span> ${bloc.title}`;
  ...
  bloc.modules.forEach((mod, idx) => {
    ...
    mod.sujets.forEach((sujet) => {
      ...
      const isChecked = progressState[bloc.id].completed.has(code)
        ? "checked"
        : "";
      sujetsHtml += `
...
function renderEvaluations() {
  ...
  let subNavHtml =
    '<div class="flex space-x-3 overflow-x-auto mb-8 pb-3 hide-scrollbar pt-2 px-2">';
  Object.values(dataEvaluations).forEach((col, index) => {
    const t = themes[col.themeKey];
    const isActive =
      index === 0
        ? `${t.bg} text-white border-paia-blue shadow-[1px_1px_0px_#0F2C48] transform translate-y-1`
        : `bg-white ${t.text} hover:bg-paia-ivory border-paia-blue shadow-[3px_3px_0px_#0F2C48]`;
...
window.onload = () => {
  document.getElementById("audioIcon").className = isVoice
    ? "fas fa-volume-up"
    : "fas fa-volume-mute";
  document.getElementById("audioLabel").innerText = isVoice
    ? "Audio ON"
    : "Audio OFF";
  updateLockBtnUI();
  ...
  Papa.parse(CSV_URL, {
    ...
    error: (err) => {
      ...
      if (loaderEl) {
        loaderEl.innerHTML =
          "<div class='p-4 text-center text-red-500 font-bold'>Erreur de chargement.</div>";
      }
    },
  });
...
window.toggleGroup = function (event, id, groupType) {
  ...
  const resMap = {
    audio: itemObj.Audio,
    excel: itemObj.Excel,
    infog: itemObj.Infographie,
    slide: itemObj.Slides,
    video: itemObj.Vidéo,
    notebook: itemObj.NoteBook_LM,
    glo: `Glossaire/${safeFileName}`,
    map: `Carte Mentale/${safeFileName}`,
    quiz: `Quiz/${safeFileName}`,
  };

  let checkableRids = [];
  if (groupType === "core")
    checkableRids = ["audio", "excel", "infog", "slide", "video"];
  if (groupType === "ext") checkableRids = ["glo", "map", "quiz"];
  if (groupType === "note") checkableRids = ["notebook"];

  const validRids = checkableRids.filter(
    (r) => resMap[r] && resMap[r].trim() !== "",
  );
  ...
  const allValidRids = allCheckable.filter(
    (r) => resMap[r] && resMap[r].trim() !== "",
  );
...
function filtrerBloc(bloc) {
  ...
  document.querySelectorAll(".tab-btn").forEach((btn) => {
    btn.className =
      "tab-btn bg-white/90 backdrop-blur-[10px] text-gray-500 border-2 border-gray-200 hover:border-paia-blue/30 hover:text-paia-blue transition-all rounded-xl px-4 py-2.5 font-black text-sm shadow-sm";
  });
  ...
  if (activeTabBtn) {
    let activeClass =
      "bg-paia-blue text-white border-paia-blue shadow-[3px_3px_0px_#0F2C48]";
    if (bloc === "ALL")
      activeClass =
        "bg-gradient-to-r from-fuchsia-600 to-violet-600 text-white border-fuchsia-700 shadow-[3px_3px_0px_#4a044e]";
    if (bloc === "B0")
      activeClass =
        "bg-sky-500 text-white border-sky-600 shadow-[3px_3px_0px_#0284c7]";
    if (bloc === "B1")
      activeClass =
        "bg-paia-blue text-white border-blue-900 shadow-[3px_3px_0px_#0f172a]";
    if (bloc === "B2")
      activeClass =
        "bg-paia-yellow text-white border-yellow-600 shadow-[3px_3px_0px_#b45309]";
    if (bloc === "B3")
      activeClass =
        "bg-paia-bronze text-white border-orange-800 shadow-[3px_3px_0px_#7c2d12]";
    if (bloc === "B4")
      activeClass =
        "bg-paia-dark text-white border-black shadow-[3px_3px_0px_#000000]";
    if (bloc === "PAY")
      activeClass =
        "bg-purple-600 text-white border-purple-800 shadow-[3px_3px_0px_#4c1d95]";
    if (bloc === "ECF")
      activeClass =
        "bg-purple-600 text-white border-purple-800 shadow-[3px_3px_0px_#4c1d95]";
...
function checkDailyRevisions() {
  ...
  const dueRevisions = savedRevisions.filter(
    (r) => !r.done && r.dateStr <= todayStr && r.days > 0,
  );
  ...
  if (dueRevisions.length > 0) {
    ...
    setTimeout(() => {
      document
        .getElementById("dailyRevisionsContent")
...
window.openSpacedRepetitionModal = function (moduleId, moduleTitle) {
  ...
  document.getElementById("sr-start-time").value =
...
window.calculateAndSaveDates = function () {
  ...
  afficherToastCustom(
    `Programme de révision généré avec succès ! 🚀`,
    "#10b981",
  );
...
window.updateSRPreview = function () {
  ...
  intervals.forEach((days) => {
    ...
    const dateStr = revDate.toLocaleDateString("fr-FR", {
      day: "numeric",
      month: "short",
    });
...
window.updateBulkPreview = function () {
  ...
  const excludeHolidays = document.getElementById(
    "bulk-exclude-holidays",
  ).checked;

  if (!startStr || !timeStr) return;

  const allowedDaysMask = [
    document.getElementById("d-1").checked,
    document.getElementById("d-2").checked,
    document.getElementById("d-3").checked,
    document.getElementById("d-4").checked,
    document.getElementById("d-5").checked,
    document.getElementById("d-6").checked,
  ...
  for (let i = 0; i < blocData.modules.length && previewCount < 3; i++) {
    for (
      let j = 0;
      j < blocData.modules[i].sujets.length && previewCount < 3;
      j++
    ) {
      let j0Date = getNextValidDate(
        currentStartDate,
        allowedDaysMask,
        excludeHolidays,
      );
      const dateStr = j0Date.toLocaleDateString("fr-FR", {
        weekday: "short",
        day: "numeric",
        month: "short",
      });
...
window.openBulkPlanModal = function () {
  ...
  document.getElementById("bulk-start-time").value =
    String(now.getHours()).padStart(2, "0") + ":00";
...
window.closeBulkPlanModal = function () {
  ...
  setTimeout(() => {
    document.getElementById("bulkPlanModal").style.display = "none";
  }, 200);
};
...
window.generateBulkPlanning = function () {
  ...
  if (!startStr || !timeStr) {
    alert("Veuillez choisir une date et une heure de début.");
    return;
  }
  ...
  savedRevisions = savedRevisions.filter(
    (r) => !subjectIds.includes(r.moduleId),
  );
  ...
  allSubjects.forEach((subject) => {
    ...
    intervals.forEach((days, index) => {
      ...
      let validRevDate = getNextValidDate(
        rawRevDate,
        allowedDaysMask,
        excludeHolidays,
      );
  ...
  closeBulkPlanModal();
  afficherToastCustom(
    `Planning de ${modulesCount} modules généré avec succès ! 🚀`,
    "#10b981",
  );
  renderCalendarView();
};
...
function renderCalendarView() {
  ...
  const urgentRevs = savedRevisions.filter(
    (r) => !r.done && r.dateStr <= todayStr,
  );
  const upcomingRevs = savedRevisions.filter(
    (r) => !r.done && r.dateStr > todayStr,
  );
  ...
  const generateRow = (rev, isUrgent) => {
    ...
    const dayStr = revDateObj.toLocaleDateString("fr-FR", {
      weekday: "short",
      day: "numeric",
      month: "short",
    });
    ...
    const bgColor = rev.done
      ? "bg-emerald-50"
      : isUrgent
        ? "bg-rose-50"
        : "bg-white";
    const borderColor = rev.done
      ? "border-emerald-400"
      : isUrgent
        ? "border-rose-400"
        : "border-paia-blue";
...
function updateLockBtnUI() {
  ...
  if (isUnlocked) {
    ...
    btn.className =
      "text-blue-600 font-black text-[9px] uppercase hover:text-red-600 transition-colors";
  } else {
    btn.innerHTML = "🔒 Mode Privé";
    btn.className =
      "text-gray-400 font-black text-[9px] uppercase transition-colors cursor-default";
  }
}
...
window.toggleAudio = function () {
  ...
  if (icon)
    icon.className = isVoice ? "fas fa-volume-up" : "fas fa-volume-mute";
...
window.lire = function (txt) {
  ...
  const txtSansEmoji = txt.replace(
...
window.toggleInlineContent = function (id, url, type, titre) {
  ...
  if (type === "embed-audio") {
    const comboHtml =
      `<div class="flex flex-col gap-4 mt-4 animate-slideIn">` +
...
function getActionLink(url, titre, type, emoji, id) {
  if (!url || url.trim() === "") {
    return {
      tag: "div",
      action: `onclick="afficherTravaux('${(titre || "").replace(/'/g, "\\'")}')" style="cursor:pointer;"`,
    };
  }
  let finalUrl = url;
  ...
  if (type === "embed-pdf" && !isUnlocked) {
    return {
      tag: "div",
      action: `onclick="handleProtectedClick('${safeUrl}', '${id}', '${safeTitre}')" style="cursor:pointer;"`,
    };
  }
  ...
  if (type === "embed-audio") {
    return {
      tag: "div",
      action: `onclick="event.stopPropagation(); toggleInlineContent('${id}', '${safeUrl}', '${type}', '${safeTitre}')" style="cursor:pointer;"`,
    };
  }

  return {
    tag: "a",
    action: `href="${safeUrl}" target="_blank" style="cursor:pointer;"`,
  };
}
...
window.verifyPin = function () {
  ...
  if (btoa(input) === ENCODED_PIN) {
    ...
    updateLockBtnUI();
    const searchInputEl = document.getElementById("searchInput");
    if (typeof afficherModules === "function")
      afficherModules(searchInputEl ? searchInputEl.value : "");
    ...
    inputEl.value = "";
    setTimeout(() => {
      inputEl.classList.remove("border-red-500", "bg-red-50", "text-red-500");
    }, 500);
  }
};
...
function renderSubTabs() {
  ...
  const createBtn = (id, label) => {
    ...
    if (currentBloc === "B0") {
      themeBg = "bg-sky-500";
      themeBorder = "border-sky-600";
    }
    if (currentBloc === "B1") {
      themeBg = "bg-paia-blue";
      themeBorder = "border-blue-900";
    }
    if (currentBloc === "B2") {
      themeBg = "bg-paia-yellow";
      themeBorder = "border-yellow-600";
    }
    if (currentBloc === "B3") {
      themeBg = "bg-paia-bronze";
      themeBorder = "border-orange-800";
    }
    if (currentBloc === "B4") {
      themeBg = "bg-paia-dark";
...
function afficherModules(filtre = "", anim = true) {
  ...
  database.forEach((itemObj) => {
    ...
    if (currentMod !== "ALL" && !id.includes(`_${currentBloc}_${currentMod}`))
      return;
    ...
    const resCore = [
      ...
      },
      {
        ...
        b: "bg-slide",
        url: itemObj.Slides
          ? itemObj.Slides.startsWith("http")
            ? itemObj.Slides
            : `Slides/${itemObj.Slides}`
          : null,
        type: "embed-presentation",
        color: "#d83b01",
      },
      {
        id: "video",
    ...
    const resExternes = [
      ...
      },
      {
        ...
        n: "Carte Mentale",
        b: "bg-map",
        url: `Carte Mentale/${safeFileName}`,
        type: "embed-map",
        color: "#ffb900",
      },
      {
    ...
    const resNote = [
      {
        ...
        n: "NoteBook_LM",
        b: "bg-notebook",
        url: itemObj.NoteBook_LM,
        type: "external",
        color: "#d946ef",
      },
    ];

    let htmlOff = resOfficiels
      .map((r, index) => {
        ...
        if (r.id === "pdf" && !isUnlocked) {
          displayEmoji = "🔒";
          tooltipText = "Document Privé (Droits d'auteur)";
          btnClass = "bg-locked";
        } else if (r.id === "pdf" && isUnlocked) {
          displayEmoji = "📄";
          tooltipText = "Cours Officiel PDF";
          btnClass = "bg-pdf";
        }
    ...
    const validRids = trackableRes
      .filter((r) => r.url && r.url.trim() !== "")
      .map((r) => r.id);
    totalCount += validRids.length;

    validRids.forEach((rid) => {
      if (progressRes[`${id}-${rid}`]) vueCount++;
    });
      ...
      return arr
        .map((r) => {
          ...
          if (!hasUrl) {
            ...
            extraDivClass =
              r.id === "notebook" ? "" : "opacity-60 grayscale-[30%]";
          } else {
            checkC = isV
              ? "bg-[#3b82f6] text-white border-[#3b82f6]"
              : "bg-white text-gray-200 border-gray-200 hover:border-[#3b82f6] hover:text-[#3b82f6]";
    ...
    const validRidsCore = resCore
      .filter((r) => r.url && r.url.trim() !== "")
      .map((r) => r.id);
    let lineCheckedCore = 0;
    validRidsCore.forEach((rid) => {
      if (progressRes[`${id}-${rid}`]) lineCheckedCore++;
    });
    const percentCore =
      validRidsCore.length > 0
        ? Math.round((lineCheckedCore / validRidsCore.length) * 100)
        : 0;
    const isCoreFull =
      validRidsCore.length > 0 && lineCheckedCore === validRidsCore.length;

    const validRidsExt = resExternes
      .filter((r) => r.url && r.url.trim() !== "")
      .map((r) => r.id);
    let lineCheckedExt = 0;
    validRidsExt.forEach((rid) => {
      if (progressRes[`${id}-${rid}`]) lineCheckedExt++;
    });
    const percentExt =
      validRidsExt.length > 0
        ? Math.round((lineCheckedExt / validRidsExt.length) * 100)
        : 0;
    const isExtFull =
      validRidsExt.length > 0 && lineCheckedExt === validRidsExt.length;

    const moduleRevs = savedRevisions.filter((r) => r.moduleId === id);

    const nbTotal = moduleRevs.length > 0 ? moduleRevs.length : 6;
    const nbDone =
      moduleRevs.length > 0 ? moduleRevs.filter((r) => r.done).length : 0;

    const badgeColorClass =
      moduleRevs.length > 0
        ? "border-rose-700 bg-rose-500"
        : "border-gray-400 bg-gray-400 opacity-70";
    const btnCalendarClass =
      moduleRevs.length > 0
        ? "bg-rose-500 text-white border-rose-700 shadow-[2px_2px_0px_#9f1239]"
        : "bg-white text-gray-400 border-gray-300 hover:text-rose-500 hover:border-rose-400 shadow-[2px_2px_0px_rgba(0,0,0,0.1)] transition-colors";
    ...
    let visualUrlForThumb =
      infogUrl && infogUrl.trim() !== "" ? infogUrl : null;
  ...
  const progressPercent =
    totalCount === 0 ? 0 : Math.round((vueCount / totalCount) * 100);
